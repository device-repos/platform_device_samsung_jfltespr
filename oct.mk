...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=jfltespr TARGET_DEVICE=jfltespr BUILD_FINGERPRINT="samsung/oct_jfltespr/jfltespr:4.4/KRT16O/user/release-keys" PRIVATE_BUILD_DESC="jfltespr-user 4.4 KRT16O release-keys"
